...
Реализуйте универсальную структуру дека для разных view (массивы или типизированные массивы)
и сравните реализацию с подходом на основе реаллокации памяти.
